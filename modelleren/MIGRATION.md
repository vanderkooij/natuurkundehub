...
| 6b | **Vervolg** — echte extractie van de gevendorde reusables naar `@nh/shared` (npm-workspaces), ontdubbelen met Videometen. Bewust losgekoppeld van de cut-over. | mid |
