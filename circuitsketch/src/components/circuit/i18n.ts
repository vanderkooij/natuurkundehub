...
const en: Dict = {
  ...
  'tool.transistor_pnp': 'PNP transistor — Base / Collector / Emitter (drag to canvas)',
  ...
  'tool.chip_stepup': 'Step-up converter — block, double-click to rename (drag to canvas)',
  'tool.chip_stepdown': 'Step-down converter — block, double-click to rename (drag to canvas)',
  'tool.chip_esp': 'ESP32 module — block, double-click to rename (drag to canvas)',
  'tool.chip_ic8': 'IC, 8-pin — block, double-click to rename (drag to canvas)',
  'tool.wire': 'Wire (W)',
  'tool.text': 'Text',
  'tool.delete': 'Delete',
  // Toolbar
...
const nl: Dict = {
  ...
  'tool.transistor_pnp': 'PNP-transistor — Basis / Collector / Emitter (sleep naar canvas)',
  ...
  'tool.chip_stepup': 'Step-up converter — blok, dubbelklik om te hernoemen (sleep naar canvas)',
  'tool.chip_stepdown': 'Step-down converter — blok, dubbelklik om te hernoemen (sleep naar canvas)',
  'tool.chip_esp': 'ESP32-module — blok, dubbelklik om te hernoemen (sleep naar canvas)',
  'tool.chip_ic8': 'IC, 8-pins — blok, dubbelklik om te hernoemen (sleep naar canvas)',
  'tool.wire': 'Draad (W)',
  'tool.text': 'Tekst',
